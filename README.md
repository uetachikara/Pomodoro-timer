...
- **開いたままのタブへ波及** — 遮断開始時に対象タブを再読み込みし、読み込み済みのページを無効化する
...
そこで遮断を開始した 2 秒後に、対象ドメインを開いているタブを AppleScript で再読み込みする。タブを閉じないのは URL を残して解除後に戻れるようにするため。
